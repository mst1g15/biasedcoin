...
#' Calculate objective function if horizon is 1. If horizon >1, iterate back to cr.exp.loss function.
#'
...
#' @param y.now scalar for response of current unit
...
#'
#'
#' @return expected value of objective function assuming current response
#'
#'
#' @export
